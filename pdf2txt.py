...
print(root_path)
files_list=recGetFileNames(root_path)
print(files_list)
...
for files in files_list:
    for file in files:
        text=convert_pdf_to_txt(os.path.expanduser(root_path+'\\'+current_files[count]+'\\'+file))
        with open(root_path+'\\'+current_files[count]+'\\'+file[:-4]+'.txt', 'w', encoding='utf-8') as wf:
            wf.write(text)
    count+=1
...
#for file in files:
    ...
    #with open(root_path+'\\'+file+'.txt', 'w', encoding='utf-8') as f:
        #f.write(text)
